...
namespace Bannerlord.BUTRLoader.Patches.PrefabExtensions
{
    internal sealed class LauncherModsPrefabExtension4 : PrefabExtensionSetAttributePatch
    {
        ...
        public static string XPath => "descendant::ListPanel[@Id='InnerPanel']//ListPanel[@DragWidget='DragWidget']";
    ...
    {
        public static string Movie => "Launcher.Mods";
        public static string XPath => "descendant::ListPanel[@Id='InnerPanel']//TextWidget[@Text='@Name']";
    ...
    {
        public static string Movie => "Launcher.Mods";
        public static string XPath => "descendant::ListPanel[@Id='InnerPanel']//TextWidget[@Text='@VersionText']";
