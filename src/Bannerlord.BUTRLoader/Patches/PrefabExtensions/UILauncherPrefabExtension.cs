...
namespace Bannerlord.BUTRLoader.Patches.PrefabExtensions
{
    internal sealed class UILauncherPrefabExtension1 : PrefabExtensionInsertAsSiblingPatch
    {
        ...
        {
            XmlDocument.LoadXml("<TextWidget WidthSizePolicy=\"StretchToParent\" HeightSizePolicy=\"CoverChildren\" VerticalAlignment=\"Bottom\" Brush=\"Launcher.Version.Text\" MarginLeft=\"7\" MarginBottom=\"25\" IsHidden=\"@IsMultiplayer\" Text=\"@VersionTextSingleplayer\"/>");
        }
